...
- Initial release as standalone crate for WASM plugin compatibility
- Provides stable types for WASM plugin development independent of rustledger-plugin version
